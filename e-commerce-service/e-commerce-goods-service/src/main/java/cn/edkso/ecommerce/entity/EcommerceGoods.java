...
import cn.edkso.ecommerce.goods.GoodsInfo;
...
import cn.edkso.ecommerce.entity.converter.BrandCategoryConverter;
import cn.edkso.ecommerce.entity.converter.GoodsCategoryConverter;
import cn.edkso.ecommerce.entity.converter.GoodsStatusConverter;
import cn.edkso.ecommerce.goods.SimpleGoodsInfo;
...
public class EcommerceGoods {
     ...
     * 将 GoodsInfo 转成实体对象
     * */
    public static EcommerceGoods of(GoodsInfo goodsInfo) {
